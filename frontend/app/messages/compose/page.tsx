...
// routes at all anymore — this uses Misence's /search-users (all
// account_types, not just creators) for lookup and the ID-keyed
// GET /keys/:userId/bundle for the prekey fetch.
//
// Relocated from app/messages/page.tsx to app/messages/compose/page.tsx
// (nav restructure, KTD1/KTD2) — /messages is now a redirect to
// /messages/conversations, the new canonical landing page, and this
// flow is reachable via a "New message" button there and via its
// existing creator-profile deep link. Internal logic is unchanged.
          ...
          {!q && (
            <div style={{ textAlign: "center", paddingTop: "60px", color: "var(--fg-muted)" }}>
              ...
              <p style={{ fontSize: "12px", marginTop: "6px", opacity: 0.6 }}>
                Search any Misence member by name — viewers and creators
              </p>
            </div>
          )}
